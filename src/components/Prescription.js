...
const Prescription = () => {
  ...
  const handleAddPrescription = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}/medicalrecords`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
  ...
  const handleSendNotification = async (patientId, recordId) => {
    try {
      ...
      const patientResponse = await fetch(
        `${process.env.REACT_APP_API_URL}/patients/id/${patientId}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
      ...
      const recordResponse = await fetch(
        `${process.env.REACT_APP_API_URL}/medicalrecords/${recordId}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
  ...
  const handleViewPrescription = async (patientId) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/medicalrecords/patient/${patientId}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
